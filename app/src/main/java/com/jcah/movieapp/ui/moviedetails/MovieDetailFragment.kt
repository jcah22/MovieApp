package com.jcah.movieapp.ui.moviedetails
...
import com.jcah.movieapp.databinding.FragmentMovieDetailBinding
...
class MovieDetailFragment : Fragment(R.layout.fragment_movie_detail) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Glide.with(requireContext()).load(("https://image.tmdb.org/t/p/w500/${args.backgroundImageUrl}")).fitCenter().into(binding.imgBackground)
        binding.txtDescription.text = args.overview
        binding.txtMovieTitle.text = args.title
        binding.txtLanguage.text = "Lenguage ${args.lenguage}"
